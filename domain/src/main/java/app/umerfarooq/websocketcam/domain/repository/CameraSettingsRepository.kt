 ...
 *
 */
package app.umerfarooq.websocketcam.domain.repository
...
interface CameraSettingsRepository {
    ...
    suspend fun update(cameraSettings: (cameraSettings: CameraSettings) -> CameraSettings)
    suspend fun getAvailableFPSRanges(cameraFacing: CameraFacing) : List<FpsRange>
}