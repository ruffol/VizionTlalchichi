...
sealed interface ServerScreenEvent {
    data object OnStartClicked : ServerScreenEvent
    data object OnStopClicked : ServerScreenEvent
    data class OnPortChanged(val port: Int) : ServerScreenEvent
    data class OnListenOnAllInterfacesChanged(val listenOnAllInterfaces: Boolean) : ServerScreenEvent
}